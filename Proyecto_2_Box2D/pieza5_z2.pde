class Piezaz2{
  ...
  Piezaz2(float x, float y, float w_, float h_){ //constructor
    w = w_;
    h = h_;
   ...
   */
    ...
    fdb.friction = 0.2; // deslice con otros objetos
    fdb.restitution = 1;   //rebote 0=no rebota, +1=rebota constantemente
    fdb.density = 0.5;  //peso del objeto
    
    FixtureDef fdc = new FixtureDef();  
    fdc.shape = circle;
    
    fdc.friction = 0.2; // deslice con otros objetos
    fdc.restitution = 1;   //rebote 0=no rebota, +1=rebota constantemente
    fdc.density = 0.5;  //peso del objeto
    
    FixtureDef fdc2 = new FixtureDef();  
    fdc2.shape = circle2;
    
    fdc2.friction = 0.2; // deslice con otros objetos
    fdc2.restitution = 1;   //rebote 0=no rebota, +1=rebota constantemente
    fdc2.density = 0.5;  //peso del objeto
