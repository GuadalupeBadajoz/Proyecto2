class PiezaL{   //hielo
   ...
   */
    ...
    fdb.friction = 0; // deslice con otros objetos
    fdb.restitution = 0.1;   //rebote 0=no rebota, +1=rebota constantemente
    fdb.density = 1;  //peso del objeto
    
    FixtureDef fdc = new FixtureDef();  
    fdc.shape = circle;
    
    fdc.friction = 0; // deslice con otros objetos
    fdc.restitution = 0.1;   //rebote 0=no rebota, +1=rebota constantemente
    fdc.density = 1;  //peso del objeto
